...
import { Target, Gamepad2, Users } from 'lucide-react';
    ...
    <>
      ...
      <section className="relative h-[420px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1659238693251-1e0f86d633ba"
            alt="Jugadores de Laser Tag"
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl text-tiger-cream max-w-3xl mx-auto whitespace-pre-line">
            {t('elJuego.subtitle')}
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 space-y-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg md:text-xl text-tiger-green/80 leading-relaxed whitespace-pre-line">
            ...
            >
              <img
                src="https://horizons-cdn.hostinger.com/a7a25aad-bbc8-4902-9e19-553c079a77c2/photo-1659238693251-1e0f86d633ba-Sek0Q.jpg"
                alt="Qué es el Laser Tag"
          ...
          >
            ...
            <p className="text-tiger-cream text-xl mb-12 max-w-3xl mx-auto whitespace-pre-line">
              {t('elJuego.ctaDesc')}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <a
                href="/precios"
                className="bg-tiger-orange hover:bg-tiger-orange/90 text-white px-12 py-5 rounded-full font-bold text-lg transition-all duration-300 hover:scale-105"
              >
                {t('elJuego.btnPrices')}
              </a>
              ...
              <a
                href="/contacto"
                className="border-2 border-tiger-golden text-tiger-golden hover:bg-tiger-golden hover:text-tiger-green px-12 py-5 rounded-full font-bold text-lg transition-all duration-300"
              >
